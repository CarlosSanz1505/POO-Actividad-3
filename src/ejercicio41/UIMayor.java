 ...
 */
public class UIMayor extends javax.swing.JFrame {

    /**
     * Creates new form UIMayor
     */
    public UIMayor() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String nums = txtNumeros.getText();
        txtMayor.setText(String.valueOf(Mayor.encontrarMayor(nums)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UIMayor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
